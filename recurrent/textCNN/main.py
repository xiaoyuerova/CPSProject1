...
train_data = pd.read_csv('../../data/single-sentence-prediction/train_data.csv')
test_data = pd.read_csv('../../data/single-sentence-prediction/test_data.csv')
...
# 网络结构、损失函数、优化器初始化
model = textCNN(embedding_matrix, vocab_size)  # 加载预训练embedding matrix
